...
wget -O sincronizar.py "https://raw.githubusercontent.com/AstroNetBielZcode/AstroModulosL/refs/heads/main/sincronizar.py"
wget -O limpeza.sh "https://raw.githubusercontent.com/AstroNetBielZcode/AstroModulosL/refs/heads/main/limpeza.sh"
